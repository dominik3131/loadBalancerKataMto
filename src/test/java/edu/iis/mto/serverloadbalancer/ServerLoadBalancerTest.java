...
public class ServerLoadBalancerTest {
    ...
    public void balancingOneServerWithOneSlotCapacity_andOneSlotVm_fillsServerWithTheVm() {
        ...
        balancing(aServerList(theServer), aVmsListWith(theVm));
    ...
    public void balancingAServerWithEnoughRoom_getsFilledWithAllVms() {
        ...
        balancing(aServerList(theServer), aVmsListWith(theFirstVm, theSecondVm));
    ...
    public void vmsShouldBeBalancedOnLessLoadedServerFirst() {
        ...
        Vm theFirstVm = a(vm().ofSize(1));
        balancing(aServerList(lessLoadedServer, moreLoadedServer), aVmsListWith(theFirstVm));
    ...
    private Vm[] aVmsListWith(Vm... theVms) {
        return theVms;
    }
